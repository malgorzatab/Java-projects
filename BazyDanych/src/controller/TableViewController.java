...
public class TableViewController implements Initializable {
    ...
    public void loadTableView(String adress, StudentModel m) {
        this.model = m;
    ...
    public void addInputStudent(String adress, StudentModel s) {
        this.model = s;
        if (!tableView.getItems().contains(s)) {
            tableView.getItems().add(s);
    ...
    public void deleteSelectedStudent(String adress, StudentModel m) {
        this.model = m;
